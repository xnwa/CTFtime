...
def index():
    if "id" not in request.cookies: 
        ...
        unique_id = request.cookies.get("id") # select id 
...
def make_cache_key():
    #A1AFD0CDeDDE485485663090FEB9C8E3XXXX lowercase mismatch
...
# https://cache-it-to-win-it.chall.lac.tf/check?uuid=a1afd0cd-edde-4854-8566-3090feb9c8e3