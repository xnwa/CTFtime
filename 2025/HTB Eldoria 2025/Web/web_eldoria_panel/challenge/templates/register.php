    ...
    <div class="retro-panel p-8 pixel-corners w-full max-w-md relative">
        ...
        <form id="registerForm" class="space-y-6">
            <div>
                ...
                <input type="text" class="retro-input" placeholder="CHOOSE USERNAME" required>
            </div>

            <div>
                <label class="block text-sm mb-2" style="color: var(--accent)">PASSWORD</label>
                <input type="password" class="retro-input" placeholder="CHOOSE PASSWORD" required>
            </div>

            <div>
                <label class="block text-sm mb-2" style="color: var(--accent)">CONFIRM PASSWORD</label>
                <input type="password" class="retro-input" placeholder="CONFIRM PASSWORD" required>
            </div>
            ...
            <div class="text-center mt-4 text-sm">
                <a href="/" style="color: var(--accent)" class="hover:opacity-80">
